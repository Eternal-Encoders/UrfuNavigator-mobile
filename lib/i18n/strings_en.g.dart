...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  String get ReportSubtitle =>
      'Report issues in the app or inaccuracies on the maps';
  String get SettingsSubtitle => 'Change language';
  ...
  String get PersonalizationSubtitle =>
      'Order of institutes on the main screen, default campus';
  String get NotificationTitle => 'Notifications';
  String get NotificationSubtitle =>
      'Class start reminders, news notifications';
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'SearchForAudiencesAndPlaces':
        return 'Search for audiences and places';
      case 'Language':
        return 'Language';
      case 'Settings':
        return 'Settings';
      case 'AreYouHavingAnyProblemsWithOurSite':
        return 'Are you having any problems with our site? Want to leave a comment or ask a question? Fill out this form!';
      case 'Feedback':
        return 'Feedback';
      case 'PersonalDataProcessingPolicyAndPrivacyPolicy':
        return 'Personal Data Processing Policy and Privacy Policy';
      case 'Contacts':
        return 'Contacts';
      case 'WC.W':
        return 'WC (W)';
      ...
      case 'FeedbackSubtitle':
        return 'Share your experience using the app';
      case 'ReportSubtitle':
        return 'Report issues in the app or inaccuracies on the maps';
      case 'SettingsSubtitle':
        return 'Change language';
      case 'LanguageTitle':
        return 'Language';
      case 'LanguageSubtitle':
        return 'Interface language selection';
      case 'PersonalizationTitle':
        return 'Personalization';
      case 'PersonalizationSubtitle':
        return 'Order of institutes on the main screen, default campus';
      case 'NotificationTitle':
        return 'Notifications';
      case 'NotificationSubtitle':
        return 'Class start reminders, news notifications';
      case 'NewsTitle':
        return 'News';
      case 'NewsSubtitle':
        return 'Select news sources';
      case 'ReportTitle':
